...
button_add_asset.grid(row=2, column=0, padx=10, pady=10)

# Button for adding model (next to 'Add Asset Type')
button_add_model = tk.Button(root, text="Add Model", command=add_model)
button_add_model.grid(row=2, column=1, padx=10, pady=10)
