...
# Adjust the column width to minimize space
window_width = root.winfo_reqwidth()
column_width = int(window_width * 0.01)  # Adjust this value as needed
for col in log_view_columns:
    log_view.column(col, width=column_width, anchor=tk.CENTER, stretch=False)
