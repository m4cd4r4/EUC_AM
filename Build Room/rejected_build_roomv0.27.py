# This script now includes a custom dialog with a numpad for entering the SAN number, 
# which appears when stock is being removed. The entered SAN number, along with the 
# timestamp, is logged in the appropriate "Timestamps" sheet based on which "Items" 
# sheet the stock is removed from.
