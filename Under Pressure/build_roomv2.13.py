...
# This is a lifeline! The app had gotten screwed up pretty bad between this version and v2.20
# Found this in an old PYINSTALLER folder !!!
...
# Changes:
# 1 - If Serial dialog is not completed, do not update the spreadsheet;
