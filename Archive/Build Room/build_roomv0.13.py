...
root.configure(bg='#020384')  # Set the background color except for spreadsheet and treeview
...
frame = tk.Frame(root, bg='#020384')
frame.pack(padx=10, pady=10, fill='both', expand=True)

# Entry field and buttons layout
entry_frame = tk.Frame(frame, bg='#020384')
...
tree.tag_configure('treeview', font=button_font)  # Use button_font for better readability

# Log view for displaying the 5 most recent changes
log_view_frame = tk.Frame(root, bg='#020384', height=100)
...
logo_label = tk.Label(root, image=logo_image, bg='#020384')  # Set the background color of the logo label
