...
# Function to update the log view with the changes in descending order
def update_log_view():
...
def update_count(operation):
    ...
    if selected_item:
        try:
            ...
            # Check if the item is one of the specified types
            if any(keyword in selected_item.lower() for keyword in ['840', 'x360', 'desktop mini']):
                ...
                # Update the count for items that do not require SAN input
